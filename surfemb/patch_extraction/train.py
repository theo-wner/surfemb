...
model = MaskRCNN(num_classes=train_dataset.num_classes, learning_rate=params_config.LEARNING_RATE)

# Initialize the TensorBoard logger
logger = TensorBoardLogger("tb_logs", name="mask_rcnn")

# Move the model to the device
model.to(params_config.DEVICE)
...
trainer = pl.Trainer(
    ...
    devices=[params_config.DEVICE_NUM],  # Specify GPU index
